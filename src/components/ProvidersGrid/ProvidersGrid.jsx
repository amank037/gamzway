    ...
    return (
        <div className='providers-grid-div' ref={gridContainerRef}>
            ...
            <div className='providers-grid-container'>
                <div className='providers-grid grid-visible'>
                    {providersImagesVisible.map((item, index) => (
                ...
                <AnimatePresence>
                    {showMore && (
                        <motion.div
                            ...
                            className='providers-grid grid-hidden'
                        >
                            {providersImagesHidden.map((item, index) => (
                                <div key={index} className='providers-grid-item'>
                                    <img src={item.src} alt={item.alt} />
                                </div>
                            ))}
            ...
            <div className='providers-grid-btn-container'>
                <button onClick={toggleShowMore} className='providers-grid-show-more-btn'>
                    <span>{showMore ? "Show Less" : "Show More"}</span>
                    <span className='show-more-arrow'>{showMore ? <i className="fa-solid fa-arrow-left"></i> : <i className="fa-solid fa-arrow-right"></i>}</span>
                </button>
            </div>
        </div>
    )
