  ...
  return (
    <div className='rummy-about-grid'>
      ...
      <div className='rummy-about-grid-item'>
        ...
        <p>
          A variation fast-paced in which every point has a predefined value.
          {showMore1 && " The first declaring player gains by using appropriate sets and sequences."}
      ...
      <div className='rummy-about-grid-item'>
        ...
        <p>
          Individuals add chips to a pool.
          {showMore2 && " Being the last person standing after removing others depending on points is the aim."}
      ...
      <div className='rummy-about-grid-item'>
        ...
        <p>
          Popular in Western markets, Gin Rummy concentrates on creating melds
          {showMore4 && " and a low deadwood point count."}
